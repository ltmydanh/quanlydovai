...
<html>
    ...
    <body>
        <h1>PHIẾU NHẬN XÉT CÔNG TÁC PHỤC VỤ ĐỒ VẢI</h1>
        <form>
            <table>
                 <tr>
                    <td>Ngày
                ...
                <tr>
                    <td>Viện/Khoa <input type="text" name="donvi" size="30" placeholder=""></td>
                </tr>
...
tháng<input type="date" name="ngay" size="10" placeholder=""><td>
                ...
                <tr>
                    <td>1.Về công tác thay đồ vải tại giường:</td>
                </tr>
                ...
                <tr>
                    <td>2. Về chất lượng đồ vải sạch:</td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                     <td>3. Những ý kiến và đề nghị khác:</td>
                </tr>
                <tr>
